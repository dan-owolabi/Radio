...
export default function FrequencyDisplay({
  ...
  return (
    <div className="bg-[#111111] rounded-3xl p-5 max-md:p-3 flex max-md:flex-col gap-8 max-md:gap-3 items-stretch border border-white/5 font-geist">
      {/* LCD Display Block */}
      <div className={`rounded-2xl flex flex-col w-[280px] h-[190px] max-md:w-full max-md:h-[120px] relative overflow-hidden shadow-[inset_0_4px_12px_rgba(0,0,0,0.6)] border border-black/40 transition-all duration-700
