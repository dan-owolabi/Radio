  ...
  return (
    <RotateDeviceOverlay>
      <AppShell>
        ...
        <div className="flex-[0.55] min-w-[700px] max-md:flex-none max-md:min-w-0 max-md:w-full flex flex-col bg-[#1E1E1E] rounded-l-[2.5rem] max-md:rounded-l-none max-md:rounded-t-[2rem] overflow-hidden border border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
        ...
        <div className="flex-[0.45] min-w-[450px] max-md:flex-none max-md:min-w-0 max-md:w-full flex flex-col gap-[3px] font-geist">
